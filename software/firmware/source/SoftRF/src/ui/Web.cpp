...
<INPUT type='text' name='igc_key' maxlength='32' size='32' value='%08X%08X%08X%08X'>\
  ...
  snprintf_P ( offset, size,
    PSTR("\
<tr>\
<th align=left>Wifi AP</th>\
<td align=right>\
<input type='radio' name='wifiap' value='0' %s>Off\
<input type='radio' name='wifiap' value='1' %s>On\
</td>\
</tr>\
<tr>\
<th align=left>Wifi STA</th>\
<td align=right>\
<input type='radio' name='wifista' value='0' %s>Off\
<input type='radio' name='wifista' value='1' %s>On\
</td>\
</tr>\
<tr>\
<th align=left>Relay OGN</th>\
<td align=right>\
<input type='radio' name='relay_ogn' value='0' %s>Off\
<input type='radio' name='relay_ogn' value='1' %s>On\
</td>\
</tr>\
<tr>\
<th align=left>Relay RF</th>\
<td align=right>\
<input type='radio' name='relay_rf' value='0' %s>Off\
<input type='radio' name='relay_rf' value='1' %s>On\
</td>\
</tr>\
<tr>\
<th align=left>Report Me</th>\
<td align=right>\
<input type='radio' name='reportme' value='0' %s>Off\
<input type='radio' name='reportme' value='1' %s>On\
</td>\
</tr>\
"),
  (!settings->wifiap  ? "checked" : "") , (settings->wifiap  ? "checked" : ""),
  (!settings->wifista ? "checked" : "") , (settings->wifista ? "checked" : ""),
  (!settings->relay_ogn ? "checked" : "") , (settings->relay_ogn ? "checked" : ""),
  (!settings->relay_rf ? "checked" : "") , (settings->relay_rf ? "checked" : ""),
  (!settings->reportme ? "checked" : "") , (settings->reportme ? "checked" : "")
  );
  ...
  snprintf_P ( offset, size,
    PSTR("\
<tr>\
<th align=left>Device Address (HEX)</th>\
<td align=right>\
<INPUT type='text' name='device_addr' maxlength='32' size='32' value='%06X'>\
</td>\
</tr>\
<tr>\
<th align=left>Relay Name</th>\
<td align=right>\
<INPUT type='text' name='name' maxlength='32' size='32' value='%s'>\
</td>\
</tr>\
<tr>\
<th align=left>Wifi SSID</th>\
<td align=right>\
<INPUT type='text' name='ssid' maxlength='32' size='32' value='%s'>\
</td>\
</tr>\
<tr>\
<th align=left>Wifi Password</th>\
<td align=right>\
<INPUT type='password' name='psk' maxlength='32' size='32' value='%s'>\
</td>\
</tr>\
<tr>\
<th align=left>Default Latitude</th>\
<td align=right>\
<INPUT type='text' name='latitude' maxlength='32' size='32' value='%f'>\
</td>\
</tr>\
<tr>\
<th align=left>Default Longitude</th>\
<td align=right>\
<INPUT type='text' name='longitude' maxlength='32' size='32' value='%f'>\
</td>\
</tr>\
"),
  settings->device_addr,
  settings->name,
  settings->ssid,
  settings->psk,
  settings->latitude,
...
void handleInput() {
  ...
  for ( uint8_t i = 0; i < server.args(); i++ ) {
    /*if (server.argName(i).equals("mode")) {
    ...
    } else if (server.argName(i).equals("wifiap")) {
      settings->wifiap = server.arg(i).toInt();
    } else if (server.argName(i).equals("wifista")) {
      settings->wifista = server.arg(i).toInt();
    } else if (server.argName(i).equals("relay_ogn")) {
      settings->relay_ogn = server.arg(i).toInt();
    } else if (server.argName(i).equals("reportme")) {
      settings->reportme = server.arg(i).toInt();
    } else if (server.argName(i).equals("relay_rf")) {
      settings->relay_rf = server.arg(i).toInt();
    } else if (server.argName(i).equals("device_addr")) {
      char buf[32 + 1];
      server.arg(i).toCharArray(buf, sizeof(buf));
      settings->device_addr = strtoul(buf +  0, NULL, 16);
      ...
      char buf[32 + 1];
      server.arg(i).toCharArray(settings->name, sizeof(settings->name));
    } else if (server.argName(i).equals("latitude")) {
      settings->latitude = server.arg(i).toFloat();
    } else if (server.argName(i).equals("longitude")) {
      settings->longitude = server.arg(i).toFloat();
...
<tr><th align=left>Wifi AP</th><td align=right>%s</td></tr>\
<tr><th align=left>Wifi STA</th><td align=right>%s</td></tr>\
<tr><th align=left>Relay OGN</th><td align=right>%s</td></tr>\
<tr><th align=left>Relay RF</th><td align=right>%s</td></tr>\
<tr><th align=left>Report Me</th><td align=right>%s</td></tr>\
<tr><th align=left>Device Address</th><td align=right>%06X</td></tr>\
<tr><th align=left>Relay Name</th><td align=right>%s</td></tr>\
<tr><th align=left>Wifi SSID</th><td align=right>%s</td></tr>\
<tr><th align=left>Default Latitude</th><td align=right>%f</td></tr>\
<tr><th align=left>Default Longitude</th><td align=right>%f</td></tr>\
</table>\
<hr>\
...
//<tr><th align=left>Protocol</th><td align=right>%d</td></tr>
  //settings->mode, settings->rf_protocol, 
  settings->band,
  ...
  settings->igc_key[0], settings->igc_key[1], settings->igc_key[2], settings->igc_key[3],
  BOOL_STR(settings->wifiap),BOOL_STR(settings->wifista),BOOL_STR(settings->relay_ogn),BOOL_STR(settings->relay_rf),BOOL_STR(settings->reportme),
  settings->device_addr,settings->name,
  settings->ssid,
  settings->latitude,
  settings->longitude  
  );
