...
#else
  {
...

    {
      ...
      case DIRECTION_NORTH_UP:
        ...
        display->drawLine(0, 0, 1, 1, GxEPD_BLACK);
...
void EPD_radar_zoom()
{
  if (EPD_zoom < ZOOM_VHIGH) EPD_zoom++;
}

void EPD_radar_unzoom()
{
  if (EPD_zoom > ZOOM_LOWEST) EPD_zoom--; else EPD_zoom = ZOOM_VHIGH;
}
