...
#include "../protocol/radio/RELAY_Protocol.h"
...
#define MAX_PKT_SIZE  maxof5(LEGACY_PAYLOAD_SIZE, OGNTP_PAYLOAD_SIZE, \
                             ...
                             UAT978_PAYLOAD_SIZE)
#define RELAY_MAXPACKET_SIZE  maxof5(MAX_PKT_SIZE,RELAY_SIZE,RELAY_STATUS_SIZE,RELAY_TONET_SIZE,RELAY_TIME_SIZE)
...
extern byte TxBuffer[RELAY_MAXPACKET_SIZE], RxBuffer[RELAY_MAXPACKET_SIZE];
...
extern bool (*protocol_decode)(void *, uint32_t,ufo_t *, ufo_t *);
