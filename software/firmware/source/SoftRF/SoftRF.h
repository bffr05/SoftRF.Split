...
//#define DUMPRFTRAFFIC
#define DUMPOGNTRAFFIC
#define DUMPRELAYTRAFFIC

#define EXCLUDE_MAVLINK
#define EXCLUDE_WATCHOUT_MODE
#define EXCLUDE_BRIDGE
...
#define SOFTRF_FIRMWARE_VERSION "2.0"
#define SOFTRF_FIRMWARE_VERSIONNUM 2.0
#define SOFTRF_USB_FW_VERSION   0x0200

#define MAXDISTANCE   40000 /* 60km */
...
#define MY_ACCESSPOINT_SSID "SoftRFAP"
#define MY_ACCESSPOINT_STA_SSID "SoftRF"
...
typedef struct UFO {
    ...
    float     latitude;
    float     longitude;
    float     refused_latitude;
    float     refused_longitude;
    time_t    refused_timestamp;
    float     altitude;
